...
public class FeedBackScreen extends AppCompatActivity {
    ...
    private void setContentIds(){
        mainBody = findViewById(R.id.feed_back_screen_main_body);
        header = findViewById(R.id.feed_back_screen_header);
        headerText = findViewById(R.id.feed_back_screen_header_text);
        backButton = findViewById(R.id.feed_back_screen_back_button);

        setValues();
    }

    private void setValues(){
        headerText.setText(Strings.FEEDBACK);
