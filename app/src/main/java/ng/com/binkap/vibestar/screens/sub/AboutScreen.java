...
public class AboutScreen extends AppCompatActivity {
    ...
    private void setContentIds(){
        mainBody = findViewById(R.id.about_screen_main_body);
        header = findViewById(R.id.about_screen_header);
        headerText = findViewById(R.id.about_screen_header_text);
        backButton = findViewById(R.id.about_screen_back_button);

        setValues();
    }

    private void setValues(){
        headerText.setText(Strings.ABOUT);
